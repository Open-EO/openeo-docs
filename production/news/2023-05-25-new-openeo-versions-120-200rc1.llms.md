...
This release includes (for the first time) a couple of breaking changes. Therefore, we’ll highlight the breaking changes below. Please consult the [changelog](https://github.com/Open-EO/openeo-processes/tree/2.0.0-rc.1/CHANGELOG.md) for a full list of changes and additions.
