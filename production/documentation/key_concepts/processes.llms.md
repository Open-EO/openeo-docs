...
As described in the [Glossary](../../documentation/key_concepts/glossary.llms.md), a process is an operation that performs a specific task on a set of parameters and returns a result.
...
![](images/processes-overview.png)

openEO process workflow overview
...
![](images/processes-udf.svg)

UDF-related process extension example
...
If you want more details about how services differ across backends, see the [Backends](../../documentation/key_concepts/backend.llms.md) page.
...
- [openEO Cube Operations](../../documentation/cube_operations.llms.md)
