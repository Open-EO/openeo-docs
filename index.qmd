...
<!-- GET STARTED CARDS -->
 ...
 <section class="alt">
  ...
  <div class="cards-grid">
    <a href="documentation/cookbook.html#load-sentinel2-rgb-composite" class="card">
      ...
      <div class="card-arrow">→ docs_light.html</div>
        ...
        <a href="documentation/cookbook.html#evi-calculation" class="card">
      <div class="card-icon">🔧</div>
    ...
    <a href="documentation/cookbook.html#cookbook-udfs" class="card">
      <div class="card-icon">🐍</div>
    ...
    <a href="client_examples/openeo-community-examples/python/RandomForest-ForestFire/RandomForestModelInference_AsUDP.ipynb" class="card">
      <div class="card-icon">📊</div>
    ...
    <a href="client_examples/openeo-community-examples/python/ManagingMultipleLargeScaleJobs/ManagingMultipleLargeScaleJobs.ipynb" class="card">
      <div class="card-icon">⚡</div>
    ...
    <a href="client_examples/openeo-community-examples/python/RandomForest-ForestFire/RandomForestModelTraining.ipynb" class="card">
