  ...
  <div class="cards-grid">
    ...
    <div class="card">
      ...
      <div class="card-actions">
        <a href="client_examples/openeo-community-examples/python/RandomForest-ForestFire/RandomForestModelTraining.ipynb" class="card-arrow">→ View notebook</a>
        <a href="jupyterlite/lab/index.html?path=notebooks/RandomForest-ForestFire/RandomForestModelTraining.ipynb" class="card-arrow" target="_blank" rel="noopener">→ Run notebook (experimental)</a>
      </div>
    </div>
  </div>
</section>
