...
<section class="alt">
  ...
  <div class="cards-grid">
    <a href="docs_light.html" class="card">
      ...
      <div class="card-icon">🔧</div>
      <h3>openEO Software</h3>
      <p>Explore the openEO software ecosystem, including clients, back-ends, and tools for building and deploying geospatial data processing workflows.</p>
