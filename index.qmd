...
[Explore load collection →](documentation/cookbook.html#load-sentinel2-rgb-composite)

[Run in JupyterLite →](jupyterlite/lab/index.html?path=notebooks/Access_CLMS/CLMS_layers_using_openEO.ipynb){target="_blank" rel="noopener"}
:::
...
[Run in JupyterLite →](jupyterlite/lab/index.html?path=notebooks/FloodNDWI/flood_ndwi.ipynb){target="_blank" rel="noopener"}
:::
...
[Run in JupyterLite →](jupyterlite/lab/index.html?path=notebooks/Heatwave/HeatwaveNL.ipynb){target="_blank" rel="noopener"}
:::
...
[Run notebook (experimental) →](jupyterlite/lab/index.html?path=notebooks/RandomForest-ForestFire/RandomForestModelInference_AsUDP.ipynb){target="_blank" rel="noopener"}
:::
