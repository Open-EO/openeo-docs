...
As described in the [Glossary](glossary.qmd), a spatiotemporal datacube is a multidimensional array with one or more spatial or temporal dimensions. In openEO, datacubes can represent both raster and vector-based Earth Observation data.
...
Datacubes are central to openEO because they provide users with a common way to work with the available Earth Observation data.
The main reasons for handling EO data as a datacube in openEO are:
...
If you want the full process-centred explanation, see the [Processes](processes.qmd) page. For more practical workflow examples, see [openEO Cube Operations](../cube_operations.qmd).
