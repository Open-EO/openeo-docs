...
![Architecture - openEO API shown in dark blue](images/arch.png)
...
| UDF Runtime            | Execution of user-defined functions, not part of the Core API. See the [UDF documentation](../cube_operations/udf.qmd) for more information. |