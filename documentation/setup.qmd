...
print(f"openEO client version: {openeo.client_version()}")
print(f"Backend API version: {connection.capabilities().api_version()}")
print("Supported output formats:")
for format_name in sorted(connection.list_file_formats()["output"]):
    print(f"- {format_name}")
```
