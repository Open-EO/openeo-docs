...
EO data in openEO are available as collections, which serve as the input for your processing jobs. Collections can be listed and inspected programmatically, or browsed via the [openEO Web Editor](openeofed.dataspace.copernicus.eu){target="_blank"}.
...
It is often easier to consult the [process listing page](../documentation/key_concepts/processes.qmd){target="_blank"} or the [openEO Web Editor](https://openeofed.dataspace.copernicus.eu){target="_blank"} sidebar.
