...
Do not confuse a UDP with a [User Defined Function](../../documentation/cube_operations/udf.llms.md). A UDP is a reusable openEO process graph composed of processes; a UDF sends custom Python or R code to the backend through `run_udf`. Prefer standardised processes within a UDP where possible, as they are generally easier to validate, optimise, and reuse across backends.
